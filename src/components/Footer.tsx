...
export default function Footer() {
  return (
    <footer className="w-full bg-transparent text-gray-200 py-6 md:py-8 border-t border-gray-200/20 mt-12">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between px-4 gap-4">
        <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-6 text-sm font-medium items-center justify-center w-full md:w-auto">
        ...
        <div className="text-xs text-gray-400 mt-2 md:mt-0 text-center w-full md:w-auto">© {new Date().getFullYear()} Zelmu Esports. All rights reserved.</div>
      </div>
    </footer>
  );
} 